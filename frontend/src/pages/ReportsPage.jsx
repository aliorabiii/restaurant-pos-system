  ...
  const loadAllReports = async () => {
    try {
      ...
      const [
        ...
        fetch(`http://localhost:5000/api/reports/overview?startDate=${startDate}&endDate=${endDate}`, { headers }),
        fetch(`http://localhost:5000/api/reports/revenue-over-time?startDate=${startDate}&endDate=${endDate}`, { headers }),
        fetch(`http://localhost:5000/api/reports/sales-by-category?startDate=${startDate}&endDate=${endDate}`, { headers }),
        fetch(`http://localhost:5000/api/reports/top-products?startDate=${startDate}&endDate=${endDate}&limit=10`, { headers }),
        fetch(`http://localhost:5000/api/reports/payment-methods?startDate=${startDate}&endDate=${endDate}`, { headers }),
        fetch(`http://localhost:5000/api/reports/sales-by-hour?startDate=${startDate}&endDate=${endDate}`, { headers }),
        fetch(`http://localhost:5000/api/reports/sales-by-day?startDate=${startDate}&endDate=${endDate}`, { headers }),
        employeesAPI.getStats(),
        // NEW EXPENSE FETCHES:
        fetch(`http://localhost:5000/api/reports/expense-overview?startDate=${startDate}&endDate=${endDate}`, { headers }),
        fetch(`http://localhost:5000/api/reports/expenses-by-category?startDate=${startDate}&endDate=${endDate}`, { headers }),
        fetch(`http://localhost:5000/api/reports/expenses-over-time?startDate=${startDate}&endDate=${endDate}`, { headers }),
        fetch(`http://localhost:5000/api/reports/top-expense-categories?startDate=${startDate}&endDate=${endDate}&limit=5`, { headers }),
        fetch(`http://localhost:5000/api/reports/financial-summary?startDate=${startDate}&endDate=${endDate}`, { headers })
      ]);
    ...
    <div className="reports-page">
      ...
      <div className="reports-header">
        <div>
          ...
          <p className="reports-subtitle">Complete financial and sales overview</p>
        </div>
      ...
      <div className="overview-stats">
        <div className="stat-card revenue">
          ...
          <div className="stat-details">
            ...
            <span className="stat-label">Subtotal: ${overviewStats?.totalSubtotal?.toFixed(2) || '0.00'}</span>
          </div>
        </div>
        ...
        <div className="stat-card expenses">
          ...
          <div className="stat-details">
            ...
            <span className="stat-label">{expenseOverview?.expenseCount || 0} expense entries</span>
          </div>
        </div>
          ...
          <table className="products-table">
            ...
            <tbody>
              {topProducts.length > 0 ? (
                ...
                <tr>
                  <td colSpan="5" className="no-data">No product data available</td>
                </tr>
              )}
            </tbody>
          </table>
              ...
              {topExpenseCategories.length > 0 ? (
                topExpenseCategories.map((expense, index) => (
                  <tr key={index}>
                    ...
                    <td className="revenue expense-amount">${expense.totalAmount.toFixed(2)}</td>
                    <td>{expense.count}</td>
                  </tr>
                ))
              ) : (
                <tr>
                  <td colSpan="5" className="no-data">No expense data available</td>
                </tr>
              )}
            </tbody>
          </table>
